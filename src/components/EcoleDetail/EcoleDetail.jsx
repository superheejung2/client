    ...
    return (
        <article className={styles.container}>
            ...
            <div>
                ...
                <div>
                    <img className={styles.logo} src='/img/logo_koreanantes.png' alt='cours de école' ></img>
                    <img className={styles.logo} src='/img/logo_printemps_coree.png' alt='cours de école' ></img>
                    <img className={styles.logo} src='/img/logo_outremer2.gif' alt='cours de école' ></img>
                    <img className={styles.logo} src='/img/logo_Nantes.png' alt='cours de école' ></img>
                    <img className={styles.logo} src='/img/logo_ambassade.png' alt='cours de école' ></img>
                    <img className={styles.logo} src='/img/logo-accoord.png' alt='cours de école' ></img>
